...
const SingleCoursewithPDFButton = () => {
    const subject = useLoaderData()

    const hadnlePDF = ()=>{
        const doc = new jsPDF("p", "pt", "a4")
        doc.html(document.querySelector("#jsprfdownload"),
        {
	...
	<div className="flex flex-wrap justify-between">
       ...
       <div>
       <button  className="bg-sky-900 px-8 py-2 rounded text-white">
            <Link to={`/checked/${subject._id}`}>
            Premium Accesss
            </Link>
        </button>
       </div>
...
<img className=' my-auto' src='https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200619211856/7-Best-Learning-Methods-for-Self-Taught-Developers.png'></img>
        </div>
    );
};

export default SingleCoursewithPDFButton;